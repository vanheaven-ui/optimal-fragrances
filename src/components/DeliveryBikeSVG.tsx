...
const DeliveryMotorbikeSVG = () => (
  ...
  >
    ...
    {/* Body of Motorbike */}
    <path
      d="M180 380 L250 250 C300 200 400 200 450 250 L500 380 L180 380 Z"
      fill="#6B46C1"
    />
    <path
      d="M480 380 L550 280 C600 230 700 230 750 280 L820 380 L480 380 Z"
      fill="#805AD5"
    />

    {/* Seat */}
    <path
      d="M400 240 C450 220 550 220 600 240 L580 270 C530 290 470 290 420 270 Z"
      fill="#2D3748"
    />
