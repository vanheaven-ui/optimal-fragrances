...
export const metadata = {
  ...
  description: 'Explore a luxurious collection of exquisite perfumes for every occasion at Optimal Fragrance.',
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`font-sans bg-ug-neutral-bg text-ug-text-dark relative`}> {/* Used generic font-sans */}
        <DrawerNavigation />
        {/* Delivery Motorbike SVG positioned at top right, now with responsive sizing */}
        <div className="fixed top-4 right-4 z-10 w-20 sm:w-28 animate-moveBike"> {/* Made the container responsive */}
